...
;
        ...
        public Int64 FindMaxMemoMasterID()
        {
            ...
            {
                MemoMasterID = Ope.FindNewIDInt64(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "TRN_InspectionIssue_Receipt", "MAX(inspection_master_id)", "");
            }
            return MemoMasterID;
        }
        ...
        public Int64 FindReturnMemoID(string strInspectionNo)
        {
            ...
            {
                CntID = Ope.FindNewIDInt64(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "TRN_InspectionIssue_Receipt", "inspection_no", " And  inspection_no = '" + strInspectionNo + "' And issue_type_id = 2 And company_id = " + GlobalDec.gEmployeeProperty.company_id + " And branch_id = " + GlobalDec.gEmployeeProperty.branch_id + " And location_id = " + GlobalDec.gEmployeeProperty.location_id);
            }
            return CntID;
        }
