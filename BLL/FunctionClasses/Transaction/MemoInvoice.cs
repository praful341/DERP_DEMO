...
namespace BLL.FunctionClasses.Transaction
{
    public class MemoInvoice
    {
        ...
        public Int64 FindMaxMemoMasterID()
        {
            ...
            {
                MemoMasterID = Ope.FindNewIDInt64(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "TRN_MemoIssue_Receipt", "MAX(memo_master_id)", "");
            }
            return MemoMasterID;
        }
        ...
        public Int64 FindReturnMemoID(string strMemoNo)
        {
            ...
            {
                CntID = Ope.FindNewIDInt64(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "TRN_MemoIssue_Receipt", "memo_no", " And  memo_no = '" + strMemoNo + "' And issue_type_id = 2 And company_id = " + GlobalDec.gEmployeeProperty.company_id + " And branch_id = " + GlobalDec.gEmployeeProperty.branch_id + " And location_id = " + GlobalDec.gEmployeeProperty.location_id);
            }
            return CntID;
        }
        public bool ISAlredySaveInspData(int p_InspMasterID)
        {
            ...
            {
                IntInvNo = Val.ToInt64(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "TRN_MemoIssue_Receipt", "inspection_master_id", " And inspection_master_id = '" + p_InspMasterID + "' And location_id = " + GlobalDec.gEmployeeProperty.location_id + ""));
            }
            if (IntInvNo == 0)
            {
                return false;
        ...
        public string ISExists(string MemoNo)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "TRN_MemoIssue_Receipt", "memo_no", "AND memo_no = '" + MemoNo + "'"));
            }
        }
