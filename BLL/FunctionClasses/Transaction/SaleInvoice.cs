...
namespace BLL.FunctionClasses.Transaction
{
    public class SaleInvoice
    {
        ...
        public Sales_InvoiceProperty Save(Sales_InvoiceProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
        ...
        public int Save_Detail(Sales_InvoiceProperty pClsProperty, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                int IntRes = 0;
        ...
        public int Delete(Sales_InvoiceProperty pClsProperty, Int32 flag, DLL.GlobalDec.EnumTran pEnum = DLL.GlobalDec.EnumTran.WithCommit, BeginTranConnection Conn = null)
        {
            try
            {
                Request Request = new Request();
        ...
        public DataTable GetPrintData(Sales_InvoiceProperty Property)
        {
            DataTable DTab = new DataTable();
            Request Request = new Request();
        ...
        public DataTable GetMemoNo()
        {
            DataTable DTab = new DataTable();
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.TRN_MemoNo_GetData;
            Request.CommandType = CommandType.StoredProcedure;
            Request.AddParams("@company_id", GlobalDec.gEmployeeProperty.company_id, DbType.Int32);
            Request.AddParams("@branch_id", GlobalDec.gEmployeeProperty.branch_id, DbType.Int32);
            Request.AddParams("@location_id", GlobalDec.gEmployeeProperty.location_id, DbType.Int32);
        ...
        public bool ISExistsInvoiceNo(string pInvoiceNo)
        {
            ...
            {
                IntInvNo = Val.ToInt64(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "TRN_SaleInvoice", "invoice_no", " And invoice_no = '" + pInvoiceNo.ToString() + "' And location_id = " + GlobalDec.gEmployeeProperty.location_id + ""));
            }
            if (IntInvNo == 0)
            {
                return false;
        ...
        public bool ISAlredySaveMemoData(int p_MemoMasterID)
        {
            Int64 IntInvNo = 0;
            if (GlobalDec.gEmployeeProperty.Allow_Developer == 0)
            {
                IntInvNo = Val.ToInt64(Ope.FindText(BLL.DBConnections.ConnectionString, BLL.DBConnections.ProviderName, "TRN_SaleInvoice", "memo_master_id", " And memo_master_id = '" + p_MemoMasterID + "' And location_id = " + GlobalDec.gEmployeeProperty.location_id + ""));
            }
            else
            {
                IntInvNo = Val.ToInt64(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "TRN_SaleInvoice", "memo_master_id", " And memo_master_id = '" + p_MemoMasterID + "' And location_id = " + GlobalDec.gEmployeeProperty.location_id + ""));
            }
            if (IntInvNo == 0)
            {
                return false;
        ...
        public DataSet DashBord_Data(string p_dtpFromDate, string p_dtpToDate)
        {

            DataSet DTab = new DataSet();
            Request Request = new Request();
            Request.CommandText = BLL.TPV.SProc.RPT_SaleInvoice_Dashboard_ALL;
            Request.CommandType = CommandType.StoredProcedure;
            Request.AddParams("@datFromDate", p_dtpFromDate, DbType.Int32);
            Request.AddParams("@datToDate", p_dtpToDate, DbType.Int32);
            Request.AddParams("@company_id", GlobalDec.gEmployeeProperty.company_id, DbType.Int32);
            Request.AddParams("@branch_id", GlobalDec.gEmployeeProperty.branch_id, DbType.Int32);
            Request.AddParams("@location_id", GlobalDec.gEmployeeProperty.location_id, DbType.Int32);
            Request.AddParams("@department_id", GlobalDec.gEmployeeProperty.department_id, DbType.Int32);
