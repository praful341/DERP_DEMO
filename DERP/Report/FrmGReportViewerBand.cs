        ...
        private void GridView1_CustomSummaryCalculate(object sender, CustomSummaryEventArgs e)
        {
            ...
            if (Val.ToString(ObjReportDetailProperty.Remark).ToUpper() == "GALAXY_REPORT")
            {
                ...
                else if (e.SummaryProcess == CustomSummaryProcess.Calculate)
                {
                    ...
                    DouRough_Wt = DouRough_Wt + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "Carat"));
                    DouSaw_Wt = DouSaw_Wt + Val.ToDecimal(GridView1.GetRowCellValue(e.RowHandle, "ro_carat"));
                ...
                else if (e.SummaryProcess == CustomSummaryProcess.Finalize)
                {
                    ...
                    //if (((GridSummaryItem)e.Item).FieldName.CompareTo("lot_no") == 0)
                    //{
                    //    if (DouCountLot > 0)
                    //    {
                    //        e.TotalValue = DouCountLot;
                    //    }
                    //    else
                    //    {
                    //        e.TotalValue = 0;
