...
{
    public partial class FrmMFGStockReportNew : DevExpress.XtraEditors.XtraForm
    {
        #region "Data Member"
        ...
        private void RbtReportType_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                if (Val.ToString(RbtReportType.EditValue) == "DETAIL")
                {
            ...
            if (ObjReportDetailProperty.Remark == "Estimation_Summary")
            {
                mIntPivot = 0;
            }
            else if (ObjReportDetailProperty.Remark == "Estimation_Detail")
            {
                mIntPivot = 1;
            }
