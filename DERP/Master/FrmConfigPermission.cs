    ...
    public partial class FrmConfigPermission : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void FillControl()
        {
            try
            {
                ...
                lueDepartment.Properties.DataSource = dtbDept;
                lueDepartment.Properties.ValueMember = "department_id";
                lueDepartment.Properties.DisplayMember = "department_name";

                DataTable dtbComp = new DataTable();
                dtbComp = objComp.GetData();
                lueCompany.Properties.DataSource = dtbComp;
                ...
                lueBranch.Properties.DataSource = dtbBranch;
                lueBranch.Properties.ValueMember = "branch_id";
                lueBranch.Properties.DisplayMember = "branch_name";

                DataTable dtbLoc = new DataTable();
                dtbLoc = objLoc.GetData();
                lueLocation.Properties.DataSource = dtbLoc;
        ...
        public void GetData()
        {
            try
            {
                ...
                grdConfigCompanyRights.DataSource = DTab;
