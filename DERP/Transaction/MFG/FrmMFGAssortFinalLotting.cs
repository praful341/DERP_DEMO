...
{
    public partial class FrmMFGAssortFinalLotting : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        #region Constructor
        public FrmMFGAssortFinalLotting()
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DialogResult result = MessageBox.Show("Do you want to save Assort Final data?", "Confirmation", MessageBoxButtons.YesNoCancel);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtnew = objAssortFinal.AssortFinalGetData(Val.ToString(lueAssort.EditValue), Val.ToString(lueSieve.EditValue), Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToString(lueSieve.Text), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Val.DBDate(dtpRateDate.Text));
                    ...
                    if (Global.Confirm("Assortment Final Data Save Succesfully.... " + "\n Are You Sure To Print ?", "DERP", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            else if (RBtnLocationType.EditValue.ToString() == "2")
                            {
                                if (RBtnType.SelectedIndex == 0)
                                {
                                    DataSet DTab_IssueJanged = objAssortFinal.Print_Assort_Final_Mumbai(Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Date, Val.DBDate(dtpRateDate.Text));
                                    ...
                                    FrmReportViewer.ShowForm_SubReport("CrtPolishGrading_Final_Main_Mumbai", 120, FrmReportViewer.ReportFolder.FINAL_MAIN_MUMBAI);
        ...
        private void btn_Print_Click(object sender, EventArgs e)
        {
            try
            {
                if (RBtnLocationType.EditValue.ToString() == "1")
                {
                    ...
                    else if (RBtnType.SelectedIndex == 3)
                    {
                        DataSet DTab_IssueJanged = objAssortFinal.Print_Assort_Final_Print4(Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Val.DBDate(dtpReceiveDate.Text), Val.DBDate(dtpRateDate.Text));
                        ...
                        for (int i = 0; i <= DTab_IssueJanged.Tables[1].Rows.Count - 1; i++)
                        {
                                ...
                                DTab_IssueJanged.Tables[1].Rows[i]["purity_name"].ToString() == "WT 9-10-11-12" || DTab_IssueJanged.Tables[1].Rows[i]["purity_name"].ToString() == "WT WK")
                            {
                                ...
                                DTab_IssueJanged.Tables[1].Rows[i]["-2_per"] = "0.00";
                                DTab_IssueJanged.Tables[1].Rows[i]["+2WT"] = "0.000";
                                DTab_IssueJanged.Tables[1].Rows[i]["+2_per"] = "0.00";
                                DTab_IssueJanged.Tables[1].Rows[i]["total_carat"] = "0.000";
                                DTab_IssueJanged.Tables[1].Rows[i]["total_per"] = "0.00";
                            }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FrmMFGAssortmentFinalStock.FrmMFGAssortFinalLotting = this;
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (Val.ToInt(lblLotSRNo.Text) != 0)
            {
                ...
                if (IntRes > 0)
                {
                    Global.Confirm("Final Data Deleted Succesfully");
                    ClearDetails();
                    btnSave.Enabled = true;
                }
                else
                {
                    Global.Confirm("Error In Final Data");
                    btnSave.Enabled = true;
                }
            }
            else
        ...
        public void GetStockData(DataTable Stock_Data)
        {
            try
            {
                ...
                {
                    RBtnLocationType.SelectedIndex = 0;
                    // lueAssort.SetEditValue("250,251,253,254,256,257,259,260,262,263,265,266,268,269,271,272,274,275,276,277,278,279,281,297,299,300,301,302,304,305,307,308,311,312,314,315,316,320,323,325,326,327,328,329,330, 331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 343, 344, 345, 347, 348, 350, 351, 352, 356, 359, 361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374, 375, 376, 377, 379, 380, 381, 382, 420, 421, 505, 506, 555, 1581, 1582, 1583, 1584, 1585, 1586, 1587, 1588, 1589, 1590, 1591, 1592, 1593,1594, 1595, 1596, 1597, 1598, 1599, 1600, 1601");
                    //lueAssort.SetEditValue("479,1603,1604,1605,1606,1607,1608,1609,1610,1611,1612,1613,1615,1616,1617,1618,1619,1620,1621,1622,1623,1624,1625,1626,1627,1628,1629,1630,1586,1681,1682,1683,1684, 1636,1637,1638,1639,1640,1641,1642,1643,278,279, 281,297,299,300,301,302,304,305,307,308,311,312,314,315,316,323,325,326,327,328,329,330, 331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 343, 344, 345, 347, 348, 350, 351, 352, 359, 361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374, 375, 376, 377, 379, 380, 381, 382, 420, 421, 555");
                    lueAssort.SetEditValue("479,1603,1604,1605,1606,1607,1608,1609,1610,1611,1612,1613,1615,1616,1617,1618,1619,1620,1621,1622,1623,1624,1625,1626,1627,1628,1629,1630,1586,1681,1682,1683,1684,1636,1637,1638,1639,1640,1641,1642,1643,278,279, 281,297,299,300,301,302,304,305,307,311,312,314,315,316,323,325,326,327,328,329,330, 331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 343, 344, 345, 347, 348, 350, 351, 352, 359, 361, 362, 363, 364, 365, 366, 367, 368, 369, 370, 371, 372, 373, 374, 375, 376, 377, 381, 382, 420, 421,1819,1820,1821,1822,1823,1824,1825,1826,1827,1828,1829,1830,448,1690,309,1831,1832,1833");
                    lueSieve.SetEditValue("13,16");
                }
