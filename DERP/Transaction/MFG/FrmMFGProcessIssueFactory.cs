    ...
    public partial class FrmMFGProcessIssueFactory : DevExpress.XtraEditors.XtraForm
    {
        ...
        private bool AddInGrid()
        {
            ...
            try
            {
                ...
                if (btnAdd.Text == "&Add")
                {
                    if (GlobalDec.gEmployeeProperty.role_name == "SURAT 4P" || GlobalDec.gEmployeeProperty.role_name == "SURAT 4P OK" || GlobalDec.gEmployeeProperty.role_name == "SURAT SARIN" || GlobalDec.gEmployeeProperty.role_name == "SURAT 4P ENTRY" || GlobalDec.gEmployeeProperty.role_name == "SURAT RUSSIAN" || GlobalDec.gEmployeeProperty.role_name == "SURAT POLISH REPARING" || GlobalDec.gEmployeeProperty.role_name == "SURAT MAKABLE" || GlobalDec.gEmployeeProperty.role_name == "SURAT KATARGAM")
                    {
                        MFGProcessIssue objMFGProcessIssue = new MFGProcessIssue();
                        MFGProcessIssueProperty objMFGProcessIssueProperty = new MFGProcessIssueProperty();
