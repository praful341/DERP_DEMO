    ...
    public partial class FrmMfgHistoryView : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmMfgHistoryView_Load(object sender, EventArgs e)
        {
            ...
            if (GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT SARIN" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT 4P" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT MAKABLE" ||
              ...
              GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT ASSORT" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT KATARGAM" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT POLISH REPARING" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT KAMALA")
            {
                if (GlobalDec.gEmployeeProperty.user_name.ToUpper() == "PRAFUL" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "DAKSHAY" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "KETAN" ||
                        ...
                        || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "JAYESHJ" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "BHADRESH" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "YOGESH" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "RAVIR" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "YTHUMMAR")
                {
