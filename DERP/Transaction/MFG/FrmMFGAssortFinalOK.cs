...
{
    public partial class FrmMFGAssortFinalOK : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        MFGAssortFinalOK objAssortFinalOK;
        ...
        public FrmMFGAssortFinalOK()
        {
            ...
            objAssortFinalOK = new MFGAssortFinalOK();
        ...
        public void FillSummaryGrid()
        {
            ...
            dgvAssortGroupTotal.OptionsView.ShowFooter = true;
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dtnew = objAssortFinalOK.AssortFinalGetData(Val.ToString(lueAssort.EditValue), Val.ToString(lueSieve.EditValue), Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToString(lueSieve.Text), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Val.DBDate(dtpRateDate.Text));
        ...
        private void backgroundWorker_AssortFinalReceive_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                MFGAssortFinalOK MFGAssortFinalOK = new MFGAssortFinalOK();
                ...
                try
                {
                    ...
                    {
                        objMFGAssortFinalOKProperty.lot_id = Val.ToInt64(txtLotId.Text);
                        objMFGAssortFinalOKProperty.flag_update = Val.ToInt(3);
                        int Lot_Flag = MFGAssortFinalOK.GetUpdateLot_ID_Flag(objMFGAssortFinalOKProperty, DLL.GlobalDec.EnumTran.Continue, Conn);
                    }

                    objMFGAssortFinalOKProperty.manager_id = Val.ToInt(0);
                    objMFGAssortFinalOKProperty.employee_id = Val.ToInt(0);
                    ...
                    //objMFGAssortFinalOKProperty.Del_lot_srno = Val.ToInt64(lblLotSRNo.Text);

                    if (Val.ToInt64(lblLotSRNo.Text) > 0)
                    {
                        Lot_SrNo = Val.ToInt64(lblLotSRNo.Text);
                        objMFGAssortFinalOKProperty.Del_lot_srno = Val.ToInt64(lblLotSRNo.Text);
                        int Lot_Delete = MFGAssortFinalOK.GetDeleteLot_ID(objMFGAssortFinalOKProperty, DLL.GlobalDec.EnumTran.Continue, Conn);
                    }
                    ...
                    //else
                    //{
                    //    dtbDetail = m_DTab.Copy();
                    //}

                    //if (dtbDetail.Rows.Count == 0)
                    //{
                    //    Global.Message("Data Not Found.. Please Check");
                    //    return;
                    //}
                    decimal Carat = 0;
                    ...
                    //        foreach (DataRow Drw in dtbDetail.Rows)
                    //        {
                    //            if (Val.ToDecimal(Drw[Val.ToString(objMFGAssortFinalLottingProperty.sieve_id) + "_" + "carat"]) > 0)
                    //            {
                    //                if (Val.ToDecimal(Drw[Val.ToString(objMFGAssortFinalLottingProperty.sieve_id) + "_" + "rate"]) == 0)
                    //                {
                    //                    Global.Confirm("Amount Cannot Be Blank Please Check!!");
                    //                }
                    //            }
                    ...
                    for (int i = dtbDetail.Columns.Count - 1; i >= 2; i--)
                    {
                        if (Val.ToString(dtbDetail.Columns[i]) == Val.ToString(dtbDetail.Columns[i]).Split('_')[0] + "_carat")
                        {
                            foreach (DataRow Drw in dtbDetail.Rows)
                            {
                                ...
                                objMFGAssortFinalOKProperty.rate = Val.ToDecimal(Drw[Val.ToString(objMFGAssortFinalOKProperty.sieve_id) + "_" + "rate"]);
                                objMFGAssortFinalOKProperty.amount = Val.ToDecimal(Drw[Val.ToString(objMFGAssortFinalOKProperty.sieve_id) + "_" + "amount"]);

                                //DataTable DTab_Rate = MFGAssortFinal.AssortFinalRateGetData(Val.ToInt32(objMFGAssortFinalLottingProperty.assort_id), Val.ToInt32(objMFGAssortFinalLottingProperty.sieve_id));

                                //if (DTab_Rate.Rows.Count > 0)
                                //{
                                //    objMFGAssortFinalLottingProperty.rate = Val.ToDecimal(DTab_Rate.Rows[0]["rate"]);
                                //    objMFGAssortFinalLottingProperty.amount = Val.ToDecimal(objMFGAssortFinalLottingProperty.rate * objMFGAssortFinalLottingProperty.to_carat);
                                //}
                                //else
                                //{
                                //    objMFGAssortFinalLottingProperty.rate = Val.ToDecimal(0);
                                //    objMFGAssortFinalLottingProperty.amount = Val.ToDecimal(0);
                                //}

                                objMFGAssortFinalOKProperty.union_id = IntRes;
                                objMFGAssortFinalOKProperty.receive_union_id = Receive_IntRes;
                                objMFGAssortFinalOKProperty.form_id = m_numForm_id;
                                objMFGAssortFinalOKProperty.history_union_id = NewHistory_Union_Id;
                                objMFGAssortFinalOKProperty.issue_union_id = NewIssue_Union_Id;
                                objMFGAssortFinalOKProperty.count = Count;
                                objMFGAssortFinalOKProperty.mix_union_id = Mix_Union_Id;
                                //if (Val.ToInt64(lblLotSRNo.Text) != 0)
                                //{
                                //    //objMFGAssortFinalLottingProperty.lot_srno = Val.ToInt64(lblLotSRNo.Text);
                                //    objMFGAssortFinalLottingProperty.new_lot_srno = Val.ToInt64(lblLotSRNo.Text);
                                //    New_Lot_SrNo = Val.ToInt64(lblLotSRNo.Text);
                                //}
                                //else
                                //{
                                //    objMFGAssortFinalLottingProperty.new_lot_srno = Val.ToInt64(0);
                                //    objMFGAssortFinalLottingProperty.lot_srno = Lot_SrNo;
                                //}
                                objMFGAssortFinalOKProperty.lot_srno = Lot_SrNo;
                                objMFGAssortFinalOKProperty.temp_sieve_name = lueSieve.Text.ToString();
                                //objMFGAssortFinalLottingProperty.assort_total_carat = Val.ToDecimal(txtMain.Text);

                                //if (objMFGAssortFinalLottingProperty.to_carat == 0)
                                //    continue;
                                if (RBtnLocationType.EditValue.ToString() == "1")
                                {
                                    objMFGAssortFinalOKProperty.location_id = Val.ToInt32(1);
                                }
                                else
                                {
                                    objMFGAssortFinalOKProperty.location_id = Val.ToInt32(2);
                                }

                                objMFGAssortFinalOKProperty = MFGAssortFinalOK.Save(objMFGAssortFinalOKProperty, DLL.GlobalDec.EnumTran.Continue, Conn);
                                //if (objMFGAssortFinalLottingProperty.new_lot_srno == 0)
                                //{
                                //    IntRes = Val.ToInt64(objMFGAssortFinalLottingProperty.union_id);
                                //}
                                //else
                                //{
                                //    IntRes = Val.ToInt64(objMFGAssortFinalLottingProperty.new_lot_srno);
                                //}

                                IntRes = objMFGAssortFinalOKProperty.union_id;
                                Receive_IntRes = Val.ToInt64(objMFGAssortFinalOKProperty.receive_union_id);
                                NewHistory_Union_Id = Val.ToInt64(objMFGAssortFinalOKProperty.history_union_id);
                    ...
                    {
                        AssortId = MFGAssortFinalOK.GetAssortId("MAIN.GHAT");
                        objMFGAssortFinalOKProperty.assort_id = Val.ToInt(AssortId);
                        objMFGAssortFinalOKProperty.sieve_id = Val.ToInt(0);
                        objMFGAssortFinalOKProperty.percentage = Val.ToDecimal(txtMainGhatPer.Text);
                        objMFGAssortFinalOKProperty.to_carat = Val.ToDecimal(txtMainGhat.Text);

                        objMFGAssortFinalOKProperty = MFGAssortFinalOK.Save(objMFGAssortFinalOKProperty, DLL.GlobalDec.EnumTran.Continue, Conn);
                        IntRes = objMFGAssortFinalOKProperty.union_id;

                        Receive_IntRes = objMFGAssortFinalOKProperty.receive_union_id;
                        NewHistory_Union_Id = Val.ToInt64(objMFGAssortFinalOKProperty.history_union_id);
                        NewIssue_Union_Id = Val.ToInt(objMFGAssortFinalOKProperty.issue_union_id);
                        Mix_Union_Id = Val.ToInt(objMFGAssortFinalOKProperty.mix_union_id);
                    }
                    if (Val.ToDecimal(txtRBaki.Text) != 0)
                    {
                        AssortId = MFGAssortFinalOK.GetAssortId("R.BAAKI");
                        objMFGAssortFinalOKProperty.assort_id = Val.ToInt(AssortId);
                        objMFGAssortFinalOKProperty.sieve_id = Val.ToInt(0);
                        objMFGAssortFinalOKProperty.percentage = Val.ToDecimal(txtRBakiPer.Text);
                        objMFGAssortFinalOKProperty.to_carat = Val.ToDecimal(txtRBaki.Text);
                        objMFGAssortFinalOKProperty.lot_srno = Lot_SrNo;
                        objMFGAssortFinalOKProperty.temp_sieve_name = lueSieve.Text.ToString();

                        objMFGAssortFinalOKProperty = MFGAssortFinalOK.GhatSave(objMFGAssortFinalOKProperty, DLL.GlobalDec.EnumTran.Continue, Conn);
                        IntRes = objMFGAssortFinalOKProperty.union_id;
                    ...
                    {
                        AssortId = MFGAssortFinalOK.GetAssortId("R.GHAT");
                        objMFGAssortFinalOKProperty.assort_id = Val.ToInt(AssortId);
                        objMFGAssortFinalOKProperty.sieve_id = Val.ToInt(0);
                        objMFGAssortFinalOKProperty.percentage = Val.ToDecimal(txtRGhatPer.Text);
                        objMFGAssortFinalOKProperty.to_carat = Val.ToDecimal(txtRGhat.Text);
                        objMFGAssortFinalOKProperty.lot_srno = Lot_SrNo;
                        objMFGAssortFinalOKProperty.temp_sieve_name = lueSieve.Text.ToString();
                    ...
                    {
                        AssortId = MFGAssortFinalOK.GetAssortId("B.GHAT");
                        objMFGAssortFinalOKProperty.assort_id = Val.ToInt(AssortId);
                        objMFGAssortFinalOKProperty.sieve_id = Val.ToInt(0);
                        objMFGAssortFinalOKProperty.percentage = Val.ToDecimal(txtBGhatPer.Text);
                        objMFGAssortFinalOKProperty.to_carat = Val.ToDecimal(txtBGhat.Text);
                        objMFGAssortFinalOKProperty.lot_srno = Lot_SrNo;
                        objMFGAssortFinalOKProperty.temp_sieve_name = lueSieve.Text.ToString();
                    ...
                    {
                        AssortId = MFGAssortFinalOK.GetAssortId("ASSORT.GHAT");
                        objMFGAssortFinalOKProperty.assort_id = Val.ToInt(AssortId);
                        objMFGAssortFinalOKProperty.sieve_id = Val.ToInt(0);
                        objMFGAssortFinalOKProperty.percentage = Val.ToDecimal(txtAssortGhatPer.Text);
                        objMFGAssortFinalOKProperty.to_carat = Val.ToDecimal(txtAssortGhat.Text);
                        objMFGAssortFinalOKProperty.lot_srno = Lot_SrNo;
                        objMFGAssortFinalOKProperty.temp_sieve_name = lueSieve.Text.ToString();
                    ...
                    if (Global.Confirm("Assortment Final OK Data Save Succesfully.... " + "\n Are You Sure To Print ?", "DERP", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            if (RBtnLocationType.EditValue.ToString() == "1")
                            {
                                ...
                                {
                                    DataSet DTab_IssueJanged = objAssortFinalOK.Print_Assort_Final(Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Date, Val.DBDate(dtpRateDate.Text));
                                    ...
                                    //DataSet DTab_IssueJanged_Print2 = objAssortFinalOK.Print_Assort_Final_Print2(Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Date);
                            ...
                            else if (RBtnLocationType.EditValue.ToString() == "2")
                            {
                                if (RBtnType.SelectedIndex == 0)
                                {
                                    DataSet DTab_IssueJanged = objAssortFinalOK.Print_Assort_Final_Mumbai(Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Date);
        ...
        private void btn_Print_Click(object sender, EventArgs e)
        {
            try
            {
                if (RBtnLocationType.EditValue.ToString() == "1")
                {
                    if (RBtnType.SelectedIndex == 0)
                    {
                        DataSet DTab_IssueJanged = objAssortFinalOK.Print_Assort_Final(Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Val.DBDate(dtpReceiveDate.Text), Val.DBDate(dtpRateDate.Text));
                        ...
                        FrmReportViewer.ShowForm_SubReport("CrtPolishGrading_Final_OK_Main", 120, FrmReportViewer.ReportFolder.ACCOUNT);
                        //FrmReportViewer.ShowForm_SubReport("CrtPolishGrading_Final_OK_Main", 120, FrmReportViewer.ReportFolder.FINAL_OK_SUB);
                    ...
                    {
                        DataSet DTab_IssueJanged = objAssortFinalOK.Print_Assort_Final_Print2(Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Val.DBDate(dtpReceiveDate.Text), Val.DBDate(dtpRateDate.Text));
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FrmMFGAssortmentFinalStock.FrmMFGAssortFinalOK = this;
        ...
        private void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (Val.ToInt(lblLotSRNo.Text) != 0)
            {
                ...
                if (IntRes > 0)
                {
                    Global.Confirm("Final OK Data Deleted Succesfully");
                    ClearDetails();
                    btnSave.Enabled = true;
                }
                else
                {
                    Global.Confirm("Error In Final OK Data");
                    btnSave.Enabled = true;
                }
            }
            else
        ...
        public void GetStockData(DataTable Stock_Data)
        {
            try
            {
                ...
                DataTable dtnew = objAssortFinalOK.AssortFinalGetData(Val.ToString(lueAssort.EditValue), Val.ToString(lueSieve.EditValue), Val.ToInt32(lueKapan.EditValue), Val.ToInt32(lueCutNo.EditValue), Val.ToInt32(lueProcess.EditValue), Val.ToInt32(lueSubProcess.EditValue), Val.ToString(lueSieve.Text), Val.ToInt64(lblLotSRNo.Text), Val.ToInt64(RBtnLocationType.EditValue), Val.DBDate(dtpRateDate.Text));
        ...
        private void btnPopUpStock_Click(object sender, EventArgs e)
        {
            try
            {
                if (Validate_PopUp())
                {
                    DataTable DTab_Stock = Global.GetStockCutwise(Val.ToInt(lueKapan.EditValue), Val.ToInt(lueCutNo.EditValue), Val.ToInt32(3));

                    FrmMFGAssortmentConfirm FrmMFGAssortmentConfirm = new FrmMFGAssortmentConfirm();
                    FrmMFGAssortmentConfirm.FrmMFGAssortFinalOK = this;
