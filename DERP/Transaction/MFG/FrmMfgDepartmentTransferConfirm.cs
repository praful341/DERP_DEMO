...
namespace DERP.Transaction
{
    public partial class FrmMfgDepartmentTransferConfirm : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (m_dtbDetails.Rows.Count > 0 && m_dtbDetails.Select("SEL = true").Length > 0)
                {
                    ...
                    if (GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT SARIN" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT KATARGAM" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT KAMALA")
                    {
        ...
        private void txtLotID_Validated(object sender, EventArgs e)
        {
            ...
            if (GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT SARIN" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT 4P" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT KATARGAM" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT KAMALA")
            {
