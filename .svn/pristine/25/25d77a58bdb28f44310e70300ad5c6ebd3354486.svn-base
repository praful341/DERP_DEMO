...
{
    public partial class FrmMFGMixSplitAssortment : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        #region Constructor
        public FrmMFGMixSplitAssortment()
        {
            InitializeComponent();
        }
        ...
        private bool ValidateDetails()
        {
            ...
            try
            {
                if (m_blnsave)
                {
                    ...
                    if (Val.ToDecimal(clmCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmRejCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmRRCarat.SummaryItem.SummaryValue) != Mix_Carat)
                    {
        ...
        private bool AddInGrid()
        {
            ...
            try
            {
                ...
                else if (btnAdd.Text == "&Update")
                {
                    if (m_dtbLotMixSplit.Select("sr_no ='" + Val.ToInt(m_update_srno) + "'").Length > 0)
                    {
                        for (int i = 0; i < m_dtbLotMixSplit.Rows.Count; i++)
                        {
                            ...
                            {
                                if (m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["rough_cut_no"].ToString() == m_cut_no.ToString())
                                {
                                    ...
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["final_lot_id"] = Val.ToInt(txtFinalLotID.Text);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["sieve_name"] = Val.ToString(lueRoughSieve.Text);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["rough_sieve_id"] = Val.ToInt(lueRoughSieve.EditValue);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["sieve_name"] = Val.ToString(lueRoughSieve.Text);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["quality_name"] = Val.ToString(lueQuality.Text);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["quality_id"] = Val.ToInt(lueQuality.EditValue);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["rough_clarity_name"] = Val.ToString(lueClarity.Text);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["rough_clarity_id"] = Val.ToInt(lueClarity.EditValue);

                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["balance_pcs"] = Val.ToInt(txtPcs.Text).ToString();
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["balance_carat"] = Val.ToDecimal(txtCarat.Text).ToString();
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["loss_carat"] = Val.ToDecimal(txtWeightLoss.Text).ToString();
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["plus_carat"] = Val.ToDecimal(txtWeightPlus.Text);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["rate"] = Val.ToDecimal(txtRate.Text);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["amount"] = Val.ToDecimal(txtAmount.Text);
                                    m_dtbLotMixSplit.Rows[dgvMixSplitAssortment.FocusedRowHandle]["edit_flag"] = Val.ToInt(1);
                ...
                dgvMixSplitAssortment.MoveLast();
            }
            catch (Exception ex)
            {
                BLL.General.ShowErrors(ex);
        ...
        private void FrmMFGMixSplit_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT MAKABLE" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT ADMIN" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT ROUGH")
                {
                    if (GlobalDec.gEmployeeProperty.user_name.ToUpper() == "PRAFUL" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "PRAGNESH" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "RAHUL")
                    {
        ...
        private void dgvMixSplit_CustomSummaryCalculate(object sender, DevExpress.Data.CustomSummaryEventArgs e)
        {
            try
            {
                ...
                dtAmount = (DataTable)grdMixSplitAssortment.DataSource;
        ...
        private void dgvMixSplit_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            try
            {
                if (e.RowHandle >= 0)
                {
                    if (e.Clicks == 2)
                    {
                        DataRow Drow = dgvMixSplitAssortment.GetDataRow(e.RowHandle);
                        btnAdd.Text = "&Update";
        ...
        private void dgvDet_CustomSummaryCalculate(object sender, DevExpress.Data.CustomSummaryEventArgs e)
        {
            try
            {
                if (Val.ToDecimal(clmKCarat.SummaryItem.SummaryValue) > 0)
                {
                    if (Val.ToDecimal(clmAmount.SummaryItem.SummaryValue) > 0 && Val.ToDecimal(clmKCarat.SummaryItem.SummaryValue) > 0)
                    {
                        m_numSummRate = Math.Round((Val.ToDecimal(clmAmount.SummaryItem.SummaryValue) / Val.ToDecimal(clmKCarat.SummaryItem.SummaryValue)), 2, MidpointRounding.AwayFromZero);
                        ...
                        txtPcs.Text = Val.ToInt(1).ToString(); //Val.ToInt(clmPcs.SummaryItem.SummaryValue).ToString();
                ...
                else
                {
                    if (Val.ToDecimal(clmAmount.SummaryItem.SummaryValue) > 0 && Val.ToDecimal(clmCarat.SummaryItem.SummaryValue) > 0)
                    {
                        ...
                        txtAmount.Text = Val.Val(clmAmount.SummaryItem.SummaryValue).ToString();
                        txtCarat.Text = Val.Val(clmCarat.SummaryItem.SummaryValue).ToString();
                        txtPcs.Text = Val.ToInt(1).ToString();  //txtPcs.Text = Val.ToInt(clmPcs.SummaryItem.SummaryValue).ToString();
                        lblTotalCrt.Text = Val.Val(clmCarat.SummaryItem.SummaryValue).ToString();
                    }
                    else
                    {
        ...
        private void repositoryItemBtnDelete_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                dgvMixSplitAssortment.DeleteRow(dgvMixSplitAssortment.GetRowHandle(dgvMixSplitAssortment.FocusedRowHandle));
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            FrmSearchLotting.FrmMFGMixSplitAssortment = this;
        ...
        private bool GenerateLotSplitDetails()
        {
            ...
            try
            {
                ...
                grdMixSplitAssortment.DataSource = m_dtbLotMixSplit;
                grdMixSplitAssortment.Refresh();
            }
            catch (Exception ex)
            {
                BLL.General.ShowErrors(ex);
        ...
        public void GetPendingStock()
        {
            try
            {
                if (Save_Validate())
                {
                    ...
                    FrmStockConfirm.FrmMFGMixSplitAssortment = this;
        ...
        private void Export1(string format, string dlgHeader, string dlgFilter)
        {
            try
            {
                ...
                if ((svDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK))
                {
                    ...
                    {
                        case "pdf":
                            dgvMixSplitAssortment.ExportToPdf(Filepath);
                            break;
                        case "xls":
                            dgvMixSplitAssortment.ExportToXls(Filepath);
                            break;
                        case "xlsx":
                            dgvMixSplitAssortment.ExportToXlsx(Filepath);
                            break;
                        case "rtf":
                            dgvMixSplitAssortment.ExportToRtf(Filepath);
                            break;
                        case "txt":
                            dgvMixSplitAssortment.ExportToText(Filepath);
                            break;
                        case "html":
                            dgvMixSplitAssortment.ExportToHtml(Filepath);
                            break;
                        case "csv":
                            dgvMixSplitAssortment.ExportToCsv(Filepath);
                            break;
                    }
        ...
        private bool DeleteDetail()
        {
            ...
            try
            {
                ...
                int IntRes = objMFGLotSplit.Delete_LottingAssortment(objMFGMixSplitProperty, DeleteData, DLL.GlobalDec.EnumTran.Continue, Conn);
