...
{
    public partial class FrmMFGMultiEployeeReturn : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        #region Constructor
        public FrmMFGMultiEployeeReturn()
        {
            InitializeComponent();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (GlobalDec.gEmployeeProperty.role_name == "SURAT 4P" || GlobalDec.gEmployeeProperty.role_name == "SURAT 4P OK" || GlobalDec.gEmployeeProperty.role_name == "SURAT SARIN" || GlobalDec.gEmployeeProperty.role_name == "SURAT 4P ENTRY" || GlobalDec.gEmployeeProperty.role_name == "SURAT RUSSIAN" || GlobalDec.gEmployeeProperty.role_name == "SURAT POLISH REPARING" || GlobalDec.gEmployeeProperty.role_name == "SURAT KATARGAM")
                    {
        ...
        private void lueSubProcess_EditValueChanged(object sender, EventArgs e)
        {
            if (lueProcess.EditValue != System.DBNull.Value && lueSubProcess.EditValue != System.DBNull.Value && Val.ToInt64(txtLotID.Text) != 0)
            {
                ...
                else if (lueSubProcess.Text == "STICTHING")
                {
                    lblRetPcs.Visible = true;
                    txtReturnPcs.Visible = true;
        ...
        private void backgroundWorker_ProcRecWeightLoss_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                var newDt = m_dtbReceiveProcess.AsEnumerable()
        ...
        private bool ValidateDetails()
        {
            ...
            try
            {
                if (m_blnsave)
                {
                    ...
                    //decimal TotalCaratSumm = Val.ToDecimal(clmReturnCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmRRCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmRejectionCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmResoCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmLoss_Carat.SummaryItem.SummaryValue) + Val.ToDecimal(clmbreakage_Carat.SummaryItem.SummaryValue) + Val.ToDecimal(clmLostCarat.SummaryItem.SummaryValue);

                    //if (Val.ToDecimal(lblOsCarat.Text) + Val.ToDecimal(ClmCaratPlus.SummaryItem.SummaryValue) + Val.ToDecimal(txtCaratPlus.Text) < TotalCaratSumm)
                    //{
                ...
                if (m_blnadd)
                {
                    ...
                    //DataView view = new DataView(m_dtbReceiveProcess);
                    ...
                    //        Balance_Pcs = Val.ToInt(m_dtbReceiveProcess.Compute("SUM(return_pcs)", "lot_id =" + Val.ToString(txtLotID.Text) + ""));
                    //        rejection_pcs = Val.ToInt(m_dtbReceiveProcess.Compute("SUM(rejection_pcs)", "lot_id =" + Val.ToString(txtLotID.Text) + ""));
                    //        rr_pcs = Val.ToInt(m_dtbReceiveProcess.Compute("SUM(rr_pcs)", "lot_id =" + Val.ToString(txtLotID.Text) + ""));
                    //        resoing_pcs = Val.ToInt(m_dtbReceiveProcess.Compute("SUM(resoing_pcs)", "lot_id =" + Val.ToString(txtLotID.Text) + ""));
                    //        breakage_pcs = Val.ToInt(m_dtbReceiveProcess.Compute("SUM(breakage_pcs)", "lot_id =" + Val.ToString(txtLotID.Text) + ""));
                    //        lost_pcs = Val.ToInt(m_dtbReceiveProcess.Compute("SUM(lost_pcs)", "lot_id =" + Val.ToString(txtLotID.Text) + ""));
                    //        Total_Pcs = Val.ToInt(txtReturnPcs.Text) + Val.ToInt(txtRejPcs.Text) + Val.ToInt(txtOutpcs.Text) + Val.ToInt(txtReSoingPcs.Text) + Val.ToInt(txtBreakPcs.Text) + Val.ToInt(txtLostPcs.Text);
                    ...
                    //else
                    //{
                    //    if ((Val.ToInt(lblOsPcs.Text)) < (Val.ToInt(txtReturnPcs.Text) + Val.ToInt(txtRejPcs.Text) + Val.ToInt(txtOutpcs.Text) + Val.ToInt(txtReSoingPcs.Text) + Val.ToInt(txtBreakPcs.Text)))
                    //    {
                    //        lstError.Add(new ListError(5, "Issue Pcs not equal to balance Pcs in this Lot = " + Val.ToString(txtLotID.Text)));
                    //        if (!blnFocus)
                    //        {
                    ...
                    //if (m_flag == 0)
                    //{
                    //int TotalPcsSumm = Val.ToInt(clmReturnPcs.SummaryItem.SummaryValue) + Val.ToInt(clmRRpcs.SummaryItem.SummaryValue) + Val.ToInt(clmRejectionPcs.SummaryItem.SummaryValue) + Val.ToInt(clmResoPcs.SummaryItem.SummaryValue) + Val.ToInt(clmLost_Pcs.SummaryItem.SummaryValue) + Val.ToInt(clmbreakage_pcs.SummaryItem.SummaryValue);
                    // decimal TotalCaratSumm = Val.ToDecimal(clmReturnCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmRRCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmRejectionCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmResoCarat.SummaryItem.SummaryValue) + Val.ToDecimal(clmLoss_Carat.SummaryItem.SummaryValue) + Val.ToDecimal(clmbreakage_Carat.SummaryItem.SummaryValue) + Val.ToDecimal(clmLossCarat.SummaryItem.SummaryValue);
                    //if (Val.ToInt(lblOsPcs.Text) < Val.ToDecimal(lblTotalPcs.Text) + TotalPcsSumm)
                    //{
                    ...
                    //    }
                    //}
                    //if (Val.ToDecimal(lblOsCarat.Text) + Val.ToDecimal(ClmCaratPlus.SummaryItem.SummaryValue) + Val.ToDecimal(txtCaratPlus.Text) < Val.ToDecimal(lblTotalCarat.Text) + TotalCaratSumm)
                    //{
                    //    lstError.Add(new ListError(5, "Entry Pcs not greater than total Pcs"));
                    //    if (!blnFocus)
                    //    {
                    ...
                    //else
                    //{
                    //int oldPcs = (m_old_RetPcs + m_old_OutPcs + m_old_RejPcs + m_old_ResawPcs + m_old_BrkPcs + m_old_LossPcs + m_old_LostPcs);
                    //decimal oldCarat = (m_old_RetCarat + m_old_OutCarat + m_old_RejCarat + m_old_ResawCarat + m_old_BrkCarat + m_old_losscarat + m_old_lostcarat);
                    ...
                    //    }
                    //}
                    //if (Val.ToInt(lblOsPcs.Text) < Val.ToInt(txtReturnPcs.Text) + Val.ToInt(txtRejPcs.Text) + Val.ToInt(txtLostPcs.Text) + Val.ToInt(txtOutpcs.Text) + Val.ToInt(txtReSoingPcs.Text) + Val.ToInt(txtBreakPcs.Text))
                    //{
                    //    lstError.Add(new ListError(5, "Entry Pcs not greater than total Pcs"));
                    //    if (!blnFocus)
                    //    {
        ...
        private void txtManualCarat_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void txtLostPcs_EditValueChanged(object sender, EventArgs e)
        {
        ...
        private void btnSearch1_Click(object sender, EventArgs e)
        {
            ...
            FrmSearchLotting.FrmMFGMultiEployeeReturn = this;
