...
namespace DERP.Report
{
    public partial class FrmMFGJangedReport : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void backgroundWorker1_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            {
                String[] myArray = { "4P PLAT", "SARIN 2P", "4P SAWING", "SARIN", "4P", "RUSSIAN", "POLISH", "GALAXY", "RUSSIAN JOBWORK", "FARSI RUSSION", "SOWABALE POLISH", "SAWABLE FARSI SARIN", "XXX-4P", "CHAPKA" };
