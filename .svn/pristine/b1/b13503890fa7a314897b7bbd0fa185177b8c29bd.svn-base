...
{
    public partial class FrmMFGPurchase : DevExpress.XtraEditors.XtraForm
    {
        #region Data Member
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            if (AddInGrid())
            {
                ...
                lueRoughShade.EditValue = DBNull.Value;
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            MFG_PurchaseProperty.invoice_no = Val.ToString(txtPartyInvoiceNo.Text);
        ...
        private void panelControl4_Paint(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(pen, 0, 90, 1500, 90);
        }
        ...
        private void lueAssortName_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                if (lueRoughSieve.ItemIndex != -1 && lueRoughShade.ItemIndex != -1)
                {
                    BranchTransfer objBranch = new BranchTransfer();
                    string p_numStockRate = string.Empty;
                    p_numStockRate = objBranch.GetLetestPrice(Val.ToInt(lueRoughSieve.EditValue), Val.ToInt(lueRoughShade.EditValue));
        ...
        private void lueRoughShade_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (e.Button.Index == 1)
            {
                FrmColorMaster frmRoughShade = new FrmColorMaster();
                frmRoughShade.ShowDialog();
                Global.LOOKUPRoughShade(lueRoughShade);
            }
        }
        private void lueSource_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (e.Button.Index == 1)
            {
                FrmMfgSourceMaster frmSource = new FrmMfgSourceMaster();
                frmSource.ShowDialog();
                Global.LOOKUPSource(lueSource);
            }
        }
        private void lueArticle_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (e.Button.Index == 1)
            {
                FrmMfgArticleMaster frmArticle = new FrmMfgArticleMaster();
                frmArticle.ShowDialog();
                Global.LOOKUPArticle(lueArticle);
            }
        }
        ...
        private void lueJangedSieve_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (e.Button.Index == 1)
            {
                FrmMfgJangedSieve frmJangedSieve = new FrmMfgJangedSieve();
                frmJangedSieve.ShowDialog();
                Global.LOOKUPJangedSieve(lueJangedSieve);
            }
        }
        ...
        {
            if (txtPartyInvoiceNo.Text != "")
            {
                txtInvoiceNo.Text = txtPartyInvoiceNo.Text;
            }
        }
        private void lueSightType_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            if (e.Button.Index == 1)
            {
                FrmMfgSightTypeMaster frmSightType = new FrmMfgSightTypeMaster();
                frmSightType.ShowDialog();
                Global.LOOKUPSight(lueSightType);
            }
        }
        private void backgroundWorker_MFGPurchase_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    objMFGPurchaseProperty.article_id = Val.ToInt(lueArticle.EditValue);
                    ...
                    foreach (DataRow drw in m_dtbPurchaseDetails.Rows)
                    {
                        ...
                        objMFGPurchaseProperty.article_id = Val.ToInt(drw["article_id"]);
        ...
        private void txtBrokeragePer_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && e.KeyChar != '.')
            {
                e.Handled = true;
        ...
        private void txtPremiumPer_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && e.KeyChar != '.')
            {
                e.Handled = true;
        ...
        private bool AddInGrid()
        {
            ...
            try
            {
                ...
                if (btnAdd.Text == "&Add")
                {
                    ...
                    drwNew["rough_shade_id"] = Val.ToInt(lueRoughShade.EditValue);
                    drwNew["color_name"] = Val.ToString(lueRoughShade.Text);

                    drwNew["rough_type_id"] = Val.ToInt(lueRoughType.EditValue);
                    drwNew["rough_type"] = Val.ToString(lueRoughType.Text);

                    drwNew["article_id"] = Val.ToInt(lueArticle.EditValue);
                    drwNew["article_name"] = Val.ToString(lueArticle.Text);
                        ...
                        for (int i = 0; i < m_dtbPurchaseDetails.Rows.Count; i++)
                        {
                            if (m_dtbPurchaseDetails.Select("purchase_detail_id ='" + m_purchase_detail_id + "' AND sr_no = '" + m_update_srno + "'").Length > 0)
                            {
                                ...
                                if (m_dtbPurchaseDetails.Rows[dgvMFGPurchaseDetails.FocusedRowHandle]["purchase_detail_id"].ToString() == m_purchase_detail_id.ToString())
                                {
                                    ...
                                    m_dtbPurchaseDetails.Rows[dgvMFGPurchaseDetails.FocusedRowHandle]["article_id"] = Val.ToInt(lueArticle.EditValue);
                                    m_dtbPurchaseDetails.Rows[dgvMFGPurchaseDetails.FocusedRowHandle]["article_name"] = Val.ToString(lueArticle.Text);
        ...
        private bool ClearDetails()
        {
            ...
            try
            {
                ...
                lueRoughShade.EditValue = System.DBNull.Value;
                txtInvoiceNo.Text = string.Empty;
                lueSightType.EditValue = System.DBNull.Value;
                lueSource.EditValue = System.DBNull.Value;
                lueArticle.EditValue = System.DBNull.Value;
                lueGroup.EditValue = System.DBNull.Value;
                lueRoughType.EditValue = System.DBNull.Value;
                lueTeam.EditValue = System.DBNull.Value;
                lueJangedSieve.EditValue = System.DBNull.Value;
                txtPcs.Text = string.Empty;
                txtCarat.Text = string.Empty;
                txtRate.Text = string.Empty;
                txtAmount.Text = string.Empty;
        ...
        private bool GeneratePurchaseDetails()
        {
            ...
            try
            {
                ...
                m_dtbPurchaseDetails.Columns.Add("article_id", typeof(int));
                m_dtbPurchaseDetails.Columns.Add("article_name", typeof(string));
