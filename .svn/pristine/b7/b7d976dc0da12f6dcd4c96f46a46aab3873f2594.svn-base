...
namespace DLL
{
    class OperationSql
    {
        ...
        public int FindNewID_Search(string pStrConnectionString, string pStrTableName, string pStrField, string pStrCriteria)
        {
            int IntRes = 0;
        ...
        public Int64 FindNewLotNo(string pStrConnectionString, string pStrTableName, string pStrField, string pStrCriteria)
        {
            Int64 IntRes = 0;
            ...
            if (DRow != null)
            {
                IntRes = Convert.ToInt64(DRow["ID"].ToString());
            }
            DRow = null;
            return IntRes;
        }
        ...
        public int ExecuteNonQuery_History(string pStrConnectionString, string pStrCommandText, CommandType pEnmCommandType, SqlParameter[] pParamList = null, GlobalDec.EnumTran pEnumTran = GlobalDec.EnumTran.WithCommit)
        {
            int IntResult = 0;
            try
            {
