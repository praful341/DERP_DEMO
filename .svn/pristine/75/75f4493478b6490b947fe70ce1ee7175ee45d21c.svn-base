    ...
    public partial class FrmMFGLock : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmMFGLock_Load(object sender, EventArgs e)
        {
            ...
            if (GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT 4P" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT MAKABLE" ||
             GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT ADMIN" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "MASTER ADMIN" || GlobalDec.gEmployeeProperty.role_name.ToUpper() == "SURAT ROUGH")
            {
                if (GlobalDec.gEmployeeProperty.user_name.ToUpper() == "PRAFUL" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "KETAN" ||
                        GlobalDec.gEmployeeProperty.user_name.ToUpper() == "LALU" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "PRAGNESH" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "KAILASH" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "RAHUL" || GlobalDec.gEmployeeProperty.user_name.ToUpper() == "JAYESH")
                {
