...
namespace BLL.FunctionClasses.Master
{
    public class RateTypeMaster
    {
        ...
        public string ISExists(string RateType, Int64 RateTypeId)
        {
            ...
            {
                return Val.ToString(Ope.FindText(BLL.DBConnections.ConnectionDeveloper, BLL.DBConnections.ProviderDeveloper, "MST_RateType", "rate_type", "AND rate_type = '" + RateType + "' AND NOT ratetype_id =" + RateTypeId));
            }
