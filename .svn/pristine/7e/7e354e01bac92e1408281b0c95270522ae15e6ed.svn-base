    ...
    public partial class FrmPartyMaster : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void FrmPartyMaster_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                m_dtbPartyType.Rows.Add("Single");
        ...
        private void btnClear_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                txtPartyCityName.Text = string.Empty;
                txtPartyFullName.Text = string.Empty;
                txtPartyAddress1.Text = string.Empty;
                txtPartyAddress2.Text = string.Empty;
                txtPartyMobileNo.Text = string.Empty;
                Party_id = 0;
            ...
            try
            {
                if (e.RowHandle >= 0)
                {
                    if (e.Clicks == 2)
                    {
                        ...
                        txtPartyCityName.Text = Val.ToString(Drow["party_city_name"]);
                        txtPartyFullName.Text = Val.ToString(Drow["party_full_name"]);
                        txtPartyAddress1.Text = Val.ToString(Drow["party_address1"]);
                        txtPartyAddress2.Text = Val.ToString(Drow["party_address2"]);
                        txtPartyMobileNo.Text = Val.ToString(Drow["party_mobile_no"]);
                        txtPartyName.Focus();
                    }
                }
            }
        ...
        private bool SaveDetails()
        {
            ...
            try
            {
                ...
                PartyMasterProperty.party_city_name = Val.ToString(txtPartyCityName.Text).ToUpper();
                PartyMasterProperty.party_full_name = Val.ToString(txtPartyFullName.Text).ToUpper();
                PartyMasterProperty.party_address1 = Val.ToString(txtPartyAddress1.Text).ToUpper();
                PartyMasterProperty.party_address2 = Val.ToString(txtPartyAddress2.Text).ToUpper();
                PartyMasterProperty.party_mobile_no = Val.ToString(txtPartyMobileNo.Text).ToUpper();

                DataTable p_dtbPartyId = new DataTable();

                if (GlobalDec.gEmployeeProperty.Allow_Developer == 0)
                {
                    p_dtbPartyId = objParty.Save_A(PartyMasterProperty, Party_id);
                    if (p_dtbPartyId.Rows.Count > 0 && (Convert.ToString(srcpathAadhar) != string.Empty || Convert.ToString(srcpathPan) != string.Empty))
                    {
                        ...
                        IntRes = objParty.Update_A(PartyMasterProperty);
                    }
                    else
                    {
                ...
                {
                    p_dtbPartyId = objParty.Save_B(PartyMasterProperty, Party_id);
                    if (p_dtbPartyId.Rows.Count > 0 && (Convert.ToString(srcpathAadhar) != string.Empty || Convert.ToString(srcpathPan) != string.Empty))
                    {
                        PartyMasterProperty.party_id = Convert.ToInt32(p_dtbPartyId.Rows[0][0]);
                        if (Convert.ToString(srcpathAadhar) != string.Empty)
                        ...
                        IntRes = objParty.Update_B(PartyMasterProperty);
                    }
                    else
                    {
                        if (Val.ToInt(lblMode.Tag) > 0)
        ...
        private bool ValidateDetails()
        {
            ...
            try
            {
                ...
                //{
                //    lstError.Add(new ListError(12, "Last Name"));
                //    if (!blnFocus)
                //    {
                //        blnFocus = true;
                //        txtLName.Focus();
                ...
                //if (lueIDProof.ItemIndex < 0)
                //{
                //    lstError.Add(new ListError(13, "ID Proff"));
                //    if (!blnFocus)
                //    {
                //        blnFocus = true;
                //        lueIDProof.Focus();
                ...
                //if (txtIDProofNo.Text == string.Empty)
                //{
                //    lstError.Add(new ListError(12, "ID Proof No"));
                //    if (!blnFocus)
                //    {
                //        blnFocus = true;
                //        txtIDProofNo.Focus();
                ...
                //if (txtQbc.Text == string.Empty)
                //{
                //    lstError.Add(new ListError(12, "QBC"));
                //    if (!blnFocus)
                //    {
                //        blnFocus = true;
                //        txtQbc.Focus();
        ...
        {
            PartyMaster objParty = new PartyMaster();
            DataSet DTab_PartyPrint = objParty.Get_PartyName_Print(Val.ToInt64(lblMode.Tag));

            FrmReportViewer FrmReportViewer = new FrmReportViewer();
            foreach (DataTable DTab in DTab_PartyPrint.Tables)
            ...
            FrmReportViewer.ShowForm_SubReport("Party_Main_Report", 120, FrmReportViewer.ReportFolder.PARTY_NAME_PRINT);

            DTab_PartyPrint = null;
